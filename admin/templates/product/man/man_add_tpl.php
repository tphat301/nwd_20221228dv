		                            ...
		                            <?php foreach($config['website']['lang'] as $k => $v) { ?>
		                                <div class="tab-pane fade show <?=($k=='vi')?'active':''?>" id="tabs-lang-<?=$k?>" role="tabpanel" aria-labelledby="tabs-lang">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <input type="text" class="form-control for-seo text-sm" name="data[address<?=$k?>]" id="address<?=$k?>" placeholder="Địa chỉ (<?=$k?>)" value="<?=(!empty($flash->has('address'.$k))) ? $flash->get('address'.$k) : @$item['address'.$k]?>" required>
		                                    </div>
