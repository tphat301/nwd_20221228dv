<?php
    ...
    $votes = $cache->get("select name$lang, desc$lang, content$lang, photo from #_news where type = ? and find_in_set('hienthi',status) order by numb asc", array('cam-nhan-khach-hang'), 'result', 7200);
