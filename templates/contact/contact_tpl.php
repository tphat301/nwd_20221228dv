<div class="title-main text-center"><span><?= $titleMain ?></span></div>

<?= $flash->getMessages("frontend") ?>

<div class="content-main">
    <div class="contact-article <?=$com=='bang-gia'? 'row' : ''?>">
        <?php if($com == 'bang-gia') {?>
            <div class="<?=$com=='bang-gia'? 'col-md-6' : ''?> content-text"><?= htmlspecialchars_decode($tblPrice['content' . $lang]) ?></div>
        ...
        <?php } else { ?>
            <div class="content-text"><?= htmlspecialchars_decode($lienhe['content' . $lang]) ?></div>
        <?php } ?>
    </div>
